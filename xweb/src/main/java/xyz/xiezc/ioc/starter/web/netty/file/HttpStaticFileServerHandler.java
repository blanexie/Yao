...
public class HttpStaticFileServerHandler extends SimpleChannelInboundHandler<xyz.xiezc.ioc.starter.web.entity.HttpRequest> {
    ...
    @Override
    public void channelRead0(ChannelHandlerContext ctx, xyz.xiezc.ioc.starter.web.entity.HttpRequest request) throws Exception {
