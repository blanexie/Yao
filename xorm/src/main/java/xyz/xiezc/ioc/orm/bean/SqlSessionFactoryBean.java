 ...
 */
package xyz.xiezc.ioc.orm.bean;
...
import xyz.xiezc.ioc.annotation.core.Init;
import xyz.xiezc.ioc.core.definition.FactoryBean;
import xyz.xiezc.ioc.orm.common.YaoMybatisException;
import xyz.xiezc.ioc.orm.common.transaction.YaoTransactionFactory;
import xyz.xiezc.ioc.orm.util.Assert;
import xyz.xiezc.ioc.orm.util.StringUtil;
import xyz.xiezc.ioc.orm.xml.XMLMapperBuilder;
